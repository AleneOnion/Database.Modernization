...
macrophyte<-macrophyte %>% 
  ...
  rename(MS_LOCATION_HISTORY_ID=LOCATION_HISTORY_ID,
         MS_EVENT_LMAS_SAMPLE_DATE=SAMPLE_DATE,
         MS_SAMPLE_PARENTGLOBAL_ID=PARENTGLOBALID,
         MS_SAMPLE_GLOBAL_ID=MACRO_SAMPLE_GLOBALID,
         MS_LMAS_SAMPLER=LMAS_SAMPLER,
         MS_TOSS_LENGTH=TOSS_LENGTH,
         MS_SAMPLE_LOCATION=SAMPLE_LOCATION,
         MS_SAMPLE_LAT=SAMPLE_LAT,
         MS_SAMPLE_LONG=SAMPLE_LONG,
         MS_DEPTH=DEPTH,
         MS_ABUNDANCE=ABUNDANCE,
         MS_SCIENTIFIC_NAME=SCIENTIFIC_NAME,
         MS_COMMON_NAME=COMMON_NAME,    
         MS_COMMENT=COMMENTS) %>% 
  mutate(MS_EVENT_LMAS_SAMPLE_DATE=ifelse(MS_LOCATION_HISTORY_ID=="0601GIL0287_DH"&MS_EVENT_LMAS_SAMPLE_DATE=="8/15/2019 4:00","8/13/2019 4:00",MS_EVENT_LMAS_SAMPLE_DATE),
         MS_EVENT_LMAS_SAMPLE_DATE=ifelse(MS_LOCATION_HISTORY_ID=="1003ROL0168_DH"&MS_EVENT_LMAS_SAMPLE_DATE=="8/29/2019 4:00","8/28/2019 4:00",MS_EVENT_LMAS_SAMPLE_DATE),
         MS_EVENT_LMAS_SAMPLE_DATE=as.Date(MS_EVENT_LMAS_SAMPLE_DATE,format="%m/%d/%Y")) %>% 
  distinct() %>% 
  select(MS_LOCATION_HISTORY_ID,MS_EVENT_LMAS_SAMPLE_DATE,
         ...
         MS_SAMPLE_LAT,MS_SAMPLE_LONG,MS_DEPTH,MS_ABUNDANCE,MS_SCIENTIFIC_NAME,MS_COMMON_NAME,MS_PICTURE,              
         MS_COMMENT)
...
ITS<-ITS %>% 
  select(MS_LOCATION_HISTORY_ID,MS_EVENT_LMAS_SAMPLE_DATE,MS_MS_EVENT_LMAS_DATA_PROVIDER,
         MS_SAMPLE_TYPE,MS_INFORMATION_TYPE,
         MS_SAMPLE_PARENTGLOBAL_ID,MS_SAMPLE_GLOBAL_ID,MS_LMAS_SAMPLER,MS_TOSS_LENGTH,MS_SAMPLE_LOCATION,
         MS_SAMPLE_LAT,MS_SAMPLE_LONG,MS_DEPTH,MS_ABUNDANCE,MS_SCIENTIFIC_NAME,MS_COMMON_NAME,MS_COMMENT)%>% 
  arrange(MS_LOCATION_HISTORY_ID,MS_EVENT_LMAS_SAMPLE_DATE,MS_MS_EVENT_LMAS_DATA_PROVIDER,
          MS_SAMPLE_TYPE,MS_INFORMATION_TYPE,
          MS_SAMPLE_PARENTGLOBAL_ID,MS_SAMPLE_GLOBAL_ID,MS_LMAS_SAMPLER,MS_TOSS_LENGTH,MS_SAMPLE_LOCATION,
          MS_SAMPLE_LAT,MS_SAMPLE_LONG,MS_DEPTH,MS_ABUNDANCE,MS_SCIENTIFIC_NAME,MS_COMMON_NAME,MS_COMMENT)
macro<-macro %>%
