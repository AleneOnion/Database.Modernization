...
sei_lci<-sei_lci %>% 
  ...
  distinct(SEI_LOCATION_HISTORY_ID,SEI_EVENT_LMAS_SAMPLE_DATE,SEI_EVENT_LMAS_DATA_PROVIDER,SEI_EVENT_LMAS_PROJECT_CDE,SEI_EVENT_LMAS_SAMPLE_TIME,SEI_SAMPLE_TYPE,SEI_INFORMATION_TYPE,.keep_all = TRUE)
...
cslap<-cslap %>% 
  rename(SEI_LOCATION_HISTORY_ID=LOCATION_ID,
         SEI_EVENT_LMAS_SAMPLE_DATE=SAMPLE_DATE,
         SEI_EVENT_LMAS_PROJECT_CDE=LAKE_PROJ_CODE,
         SEI_EVENT_LMAS_DATA_PROVIDER=DATA_PROVIDER,
         SEI_EVENT_LMAS_SAMPLE_TIME=TIME,
         SEI_SAMPLE_TYPE=SAMPLE_TYPE,
         SEI_INFORMATION_TYPE=INFO_TYPE,
         SEI_SAMPLE_NAME=SAMPLE_NAME,
         SEI_PURPOSE=PURPOSE) %>% 
  mutate(SEI_EVENT_LMAS_SAMPLE_DATE=as.Date(SEI_EVENT_LMAS_SAMPLE_DATE,format="%m/%d/%Y"),
         SEI_EVENT_LMAS_SAMPLE_TIME=ifelse(grepl("PM",SEI_EVENT_LMAS_SAMPLE_TIME)&grepl("^\\d:",SEI_EVENT_LMAS_SAMPLE_TIME),gsub("^1:","13:",SEI_EVENT_LMAS_SAMPLE_TIME),SEI_EVENT_LMAS_SAMPLE_TIME),
         SEI_EVENT_LMAS_SAMPLE_TIME=ifelse(grepl("PM",SEI_EVENT_LMAS_SAMPLE_TIME)&grepl("^\\d:",SEI_EVENT_LMAS_SAMPLE_TIME),gsub("^2:","14:",SEI_EVENT_LMAS_SAMPLE_TIME),SEI_EVENT_LMAS_SAMPLE_TIME),
         SEI_EVENT_LMAS_SAMPLE_TIME=ifelse(grepl("PM",SEI_EVENT_LMAS_SAMPLE_TIME)&grepl("^\\d:",SEI_EVENT_LMAS_SAMPLE_TIME),gsub("^3:","15:",SEI_EVENT_LMAS_SAMPLE_TIME),SEI_EVENT_LMAS_SAMPLE_TIME),
         SEI_EVENT_LMAS_SAMPLE_TIME=ifelse(grepl("PM",SEI_EVENT_LMAS_SAMPLE_TIME)&grepl("^\\d:",SEI_EVENT_LMAS_SAMPLE_TIME),gsub("^4:","16:",SEI_EVENT_LMAS_SAMPLE_TIME),SEI_EVENT_LMAS_SAMPLE_TIME),
         SEI_EVENT_LMAS_SAMPLE_TIME=ifelse(grepl("PM",SEI_EVENT_LMAS_SAMPLE_TIME)&grepl("^\\d:",SEI_EVENT_LMAS_SAMPLE_TIME),gsub("^5:","17:",SEI_EVENT_LMAS_SAMPLE_TIME),SEI_EVENT_LMAS_SAMPLE_TIME),
         SEI_EVENT_LMAS_SAMPLE_TIME=ifelse(grepl("PM",SEI_EVENT_LMAS_SAMPLE_TIME)&grepl("^\\d:",SEI_EVENT_LMAS_SAMPLE_TIME),gsub("^6:","18:",SEI_EVENT_LMAS_SAMPLE_TIME),SEI_EVENT_LMAS_SAMPLE_TIME),
         SEI_EVENT_LMAS_SAMPLE_TIME=ifelse(grepl("PM",SEI_EVENT_LMAS_SAMPLE_TIME)&grepl("^\\d:",SEI_EVENT_LMAS_SAMPLE_TIME),gsub("^7:","19:",SEI_EVENT_LMAS_SAMPLE_TIME),SEI_EVENT_LMAS_SAMPLE_TIME),
         SEI_EVENT_LMAS_SAMPLE_TIME=gsub("\\sAM","",SEI_EVENT_LMAS_SAMPLE_TIME),
         SEI_EVENT_LMAS_SAMPLE_TIME=gsub("\\sPM","",SEI_EVENT_LMAS_SAMPLE_TIME),
         SEI_EVENT_LMAS_SAMPLE_TIME=ifelse(grepl("^\\d:",SEI_EVENT_LMAS_SAMPLE_TIME),paste("0",SEI_EVENT_LMAS_SAMPLE_TIME,sep=""),SEI_EVENT_LMAS_SAMPLE_TIME),
         SEI_EVENT_LMAS_SAMPLE_TIME=ifelse(is.na(SEI_EVENT_LMAS_SAMPLE_TIME),"00:00:00",SEI_EVENT_LMAS_SAMPLE_TIME),
         SEI_EVENT_LMAS_SAMPLE_TIME=paste(SEI_EVENT_LMAS_SAMPLE_DATE," ",SEI_EVENT_LMAS_SAMPLE_TIME,sep=""),
         SEI_EVENT_LMAS_PROJECT_CDE=as.character(SEI_EVENT_LMAS_PROJECT_CDE),
         SEI_SAMPLE_ID=NA,
         SEI_LOCATION_HISTORY_ID=toupper(SEI_LOCATION_HISTORY_ID),
         SEI_EVENT_LMAS_PROJECT_CDE=toupper(SEI_EVENT_LMAS_PROJECT_CDE),
  ...
  select(SEI_LOCATION_HISTORY_ID,SEI_EVENT_LMAS_SAMPLE_DATE,SEI_EVENT_LMAS_DATA_PROVIDER,SEI_EVENT_LMAS_PROJECT_CDE,SEI_EVENT_LMAS_SAMPLE_TIME,SEI_SAMPLE_TYPE,SEI_INFORMATION_TYPE,SEI_SAMPLE_NAME,SEI_SAMPLE_ID,SEI_PURPOSE)
SEI<-SEI %>% 
  select(SEI_LOCATION_HISTORY_ID,SEI_EVENT_LMAS_SAMPLE_DATE,SEI_EVENT_LMAS_DATA_PROVIDER,SEI_EVENT_LMAS_PROJECT_CDE,SEI_EVENT_LMAS_SAMPLE_TIME,SEI_SAMPLE_TYPE,SEI_INFORMATION_TYPE,SEI_SAMPLE_NAME,SEI_SAMPLE_ID,SEI_PURPOSE) %>% 
  mutate(SEI_EVENT_LMAS_PROJECT_CDE=as.character(SEI_EVENT_LMAS_PROJECT_CDE),
...
habs<-habs %>% 
  rename(SEI_LOCATION_HISTORY_ID=LOCATION_HISTORY_ID,
         SEI_EVENT_LMAS_SAMPLE_DATE=SAMPLE_DATE,
         SEI_EVENT_LMAS_PROJECT_CDE=PROJECT_CDE,
         SEI_EVENT_LMAS_DATA_PROVIDER=DATA_PROVIDER,
         SEI_SAMPLE_TYPE=SAMPLE_TYPE,
  ...
  mutate(SEI_EVENT_LMAS_SAMPLE_DATE=as.Date(SEI_EVENT_LMAS_SAMPLE_DATE,format="%Y-%m-%d"),
         ...
         SEI_PURPOSE=toupper(SEI_PURPOSE),
         SEI_SAMPLE_ID=NA) %>% 
  select(SEI_LOCATION_HISTORY_ID,SEI_EVENT_LMAS_SAMPLE_DATE,SEI_EVENT_LMAS_DATA_PROVIDER,SEI_EVENT_LMAS_PROJECT_CDE,SEI_SAMPLE_TYPE,SEI_INFORMATION_TYPE,SEI_SAMPLE_NAME,SEI_SAMPLE_ID,SEI_PURPOSE) %>% 
  distinct()
habs<-merge(habs,event,by=c('SEI_LOCATION_HISTORY_ID','SEI_EVENT_LMAS_SAMPLE_DATE','SEI_EVENT_LMAS_PROJECT_CDE','SEI_EVENT_LMAS_DATA_PROVIDER'),all.x=TRUE)
habs<-habs %>%   
  select(SEI_LOCATION_HISTORY_ID,SEI_EVENT_LMAS_SAMPLE_DATE,SEI_EVENT_LMAS_DATA_PROVIDER,SEI_EVENT_LMAS_PROJECT_CDE,SEI_EVENT_LMAS_SAMPLE_TIME,SEI_SAMPLE_TYPE,SEI_INFORMATION_TYPE,SEI_SAMPLE_NAME,SEI_SAMPLE_ID,SEI_PURPOSE) %>% 
  distinct()
sei<-sei %>% 
...
event<-event %>% 
  arrange(SEI_LOCATION_HISTORY_ID,SEI_EVENT_LMAS_SAMPLE_DATE,SEI_EVENT_LMAS_PROJECT_CDE,SEI_EVENT_LMAS_DATA_PROVIDER,SEI_EVENT_LMAS_SAMPLE_TIME) %>% 
  mutate(event="this")
SEI<-SEI %>% 
  arrange(SEI_LOCATION_HISTORY_ID,SEI_EVENT_LMAS_SAMPLE_DATE,SEI_EVENT_LMAS_PROJECT_CDE,SEI_EVENT_LMAS_DATA_PROVIDER,SEI_EVENT_LMAS_SAMPLE_TIME)


junk<-merge(event,SEI,by=c('SEI_LOCATION_HISTORY_ID','SEI_EVENT_LMAS_SAMPLE_DATE','SEI_EVENT_LMAS_PROJECT_CDE','SEI_EVENT_LMAS_DATA_PROVIDER','SEI_EVENT_LMAS_SAMPLE_TIME'),all=TRUE)
junk<-junk %>% filter(is.na(event))
#SHOULD HAVE 0 RECORDS

#check for fields with NA records
#only these fields should have NA: "SEI_EVENT_LMAS_PROJECT_CDE" "SEI_SAMPLE_ID"     "SEI_SAMPLE_NAME"     "SEI_PURPOSE"
...
ITS<-ITS %>% 
  select(SEI_SEI_LOCATION_HISTORY_ID,
         ...
         SEI_SEI_EVENT_LMAS_PROJECT_CDE,
