...
ITS<-ITS %>% 
  select(WCFD_WCFD_LOCATION_HISTORY_ID,WCFD_WCFD_EVENT_LMAS_SAMPLE_DATE,WCFD_EVENT_LMAS_SAMPLE_TIME,WCFD_WCFD_EVENT_LMAS_DATA_PROVIDER,WCFD_SAMPLE_TYPE,WCFD_INFORMATION_TYPE,
         WCFD_GLOBAL_ID,WCFD_START_DEPTH,WCFD_END_DEPTH,WCFD_EQUIPMENT_TYPE,
         WCFD_EQUIPMENT_DESC,WCFD_SAMPLE_METHOD) %>% 
  arrange(WCFD_WCFD_LOCATION_HISTORY_ID,WCFD_WCFD_EVENT_LMAS_SAMPLE_DATE,WCFD_EVENT_LMAS_SAMPLE_TIME,WCFD_WCFD_EVENT_LMAS_DATA_PROVIDER,WCFD_SAMPLE_TYPE,WCFD_INFORMATION_TYPE,
          WCFD_GLOBAL_ID,WCFD_START_DEPTH,WCFD_END_DEPTH,WCFD_EQUIPMENT_TYPE,
          WCFD_EQUIPMENT_DESC,WCFD_SAMPLE_METHOD)
wc<-wc %>%
  select(WCFD_WCFD_LOCATION_HISTORY_ID,WCFD_WCFD_EVENT_LMAS_SAMPLE_DATE,WCFD_EVENT_LMAS_SAMPLE_TIME,WCFD_WCFD_EVENT_LMAS_DATA_PROVIDER,WCFD_SAMPLE_TYPE,WCFD_INFORMATION_TYPE,
...
wc<-wc %>% 
  mutate(WCFD_WCFD_EVENT_LMAS_SAMPLE_DATE=as.Date(WCFD_WCFD_EVENT_LMAS_SAMPLE_DATE,format="%Y-%m-%d"))
ITS<-ITS %>% 
  mutate(WCFD_WCFD_EVENT_LMAS_SAMPLE_DATE=as.Date(WCFD_WCFD_EVENT_LMAS_SAMPLE_DATE,format="%m/%d/%Y"))
